...
public class KafkaConfig {
    ...
    @Bean
    public ProducerFactory<String, SyncStudentDto> syncStudentDtoProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, SyncStudentDto> syncStudentDtoKafkaTemplate() {
        return new KafkaTemplate<>(syncStudentDtoProducerFactory());
    }
}
