...
Для организации родительского комитета  в системе необходимо создать свою группу и пригласить туда других пользовтелей.
...
Обычные пользователи имеют доступ к ленте наовостей. 
